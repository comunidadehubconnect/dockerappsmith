...
<p align="center">Seja bem-vindo ao Guia de Instalação Docker Appsmith 🚀</p>
</p>
...
services:
  appsmith:
    ...
    environment:
      - APPSMITH_CUSTOM_DOMAIN=https://appsmith.dominio.com.br
      - APPSMITH_SUPERVISOR_USER=user
      - APPSMITH_SUPERVISOR_PASSWORD=password
    deploy:
      labels:
        - traefik.enable=true
        - traefik.http.routers.metabase.rule=Host(`appsmith.dominio.com.br`)
